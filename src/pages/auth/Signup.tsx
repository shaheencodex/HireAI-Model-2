    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          paddingTop: verifyMsg ? 96 : undefined,
        }}
      >
        <div className="hero">
          ...
          <h2 className="title text-white">
            From job description to shortlisting.
          </h2>
          <p className="subtitle">
            Resume sorting, interviews, and insights all powered by AI.
          </p>
        ...
        <div className="card">
          ...
          <form onSubmit={handleRegister} className="form">
            ...
            >
              ...
              >
                <path
                  d="M533.5 278.4c0-18.2-1.5-36-4.4-53.2H272v100.6h146.9c-6.3 34.1-25.6 63-54.6 82.3v68.3h88.3c51.5-47.5 81.9-117.5 81.9-198z"
                  fill="#4285f4"
                />
                <path
                  d="M272 544.3c73.5 0 135.2-24.4 180.3-66.3l-88.3-68.3c-24.5 16.5-55.7 26-92 26-70.8 0-130.7-47.8-152.2-112.2H29.8v70.8C74.9 483.6 166 544.3 272 544.3z"
                  fill="#34a853"
                />
                <path
                  d="M119.8 320.4c-9.5-28.4-9.5-58.6 0-87l-89.9-70.7c-39 77.5-39 169.1 0 246.6l89.9-70.9z"
                  fill="#fbbc04"
                />
                <path
                  d="M272 107.7c39.9-.6 77.1 14 105.8 40.7l79.5-79.5C407 23.6 345.2-1.1 272 0 166 0 74.9 60.7 29.8 149.1l89.9 70.7C141.3 155.5 201.2 107.7 272 107.7z"
                  fill="#ea4335"
                />
              </svg>
