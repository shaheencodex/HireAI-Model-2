        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="border-b pb-3">
              ...
              <p className="text-sm text-gray-500 mt-2">Oct 30, 2025</p>
            </div>
            <div className="border-b pb-3">
              <div className="flex justify-between items-start">
                <div>
              ...
              <p className="text-sm text-gray-500 mt-2">Oct 31, 2025</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="border-b pb-3">
              ...
              <p className="text-sm text-gray-500 mt-2">5 candidates matched</p>
            </div>
            <div className="border-b pb-3">
              <div className="flex justify-between items-start">
                <div>
              ...
              <p className="text-sm text-gray-500 mt-2">3 candidates matched</p>
            </div>
          </div>
        </div>
      </div>
